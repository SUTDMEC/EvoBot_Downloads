...
try
    ...
    % number of robot
    in.robot_num=2; % number of robots connected
    in.s=s;
    ...
    for i=1:in.robot_num %running the loop for each robot
        ...
        fprintf(in.fileID(i),'\n\r\n\rTime,Current,Voltage,IR_L,IR_C,IR_R,IMU_DISP_X,IMU_DISP_Y,YAW,OPT_X,OPT_Y,ENCODER_X,ENCODER_Y,L_SPEED,R_SPEED\n\r');
