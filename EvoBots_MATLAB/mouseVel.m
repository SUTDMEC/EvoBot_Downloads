function [ v1,v2,theta,thetaP2 ] = mouseVel( mouseData,theta0,dT )
...
%         end
        ...
        if abs(thetaP2(i+1))>pi/2 %wrap to 90 instead of 180, staying with the optitrack format
            if thetaP2(i+1)<0
                sign=-1;
            else
                sign=1;
