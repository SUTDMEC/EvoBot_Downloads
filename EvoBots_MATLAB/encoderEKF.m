function [xout,yout,thetaout,thetaP2]=encoderEKF( encoderData,ctrvec,senseTime,x0,y0,theta0)
...
xV = zeros(nStates,length(encoderData.Left));%x(7,:)=xpos x(8,:)=ypos x(9,:)=theta
xV(5,1)=theta0;
xV(7,1)=x0;
xV(8,1)=y0;
xV(9,1)=theta0;
...
[ vxm,vym,thetam,thetaP2m ] = encoderVel( encoderData,theta0,dT ); 
