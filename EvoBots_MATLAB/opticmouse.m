function opticmouse(timerObj,event,in)
...
try
	...
	%calculate the distance moved in the case that the mouse pointer wasn't reset
     ...
     move_x=rel_distancematrix(1)/in.mouse_constant_dx;%added as titlt offset - yash
     move_y=rel_distancematrix(2)/in.mouse_constant_dy;%added as titlt offset - yash
