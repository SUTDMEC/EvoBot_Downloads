...
dir='Z:\Temasek Laboratories\STARS\RightMouse\';
in.mouseFID= fopen(strcat(dir,'right_mouse_data',datestr(now,'yy_mm_dd'),'.csv'),'wt');
...
in.mouse_constant_dy=318; %mouse-dependent scaling parameter to get distance travelled in m
...
timerObj = timer('TimerFcn',{'opticmouse_sat',in}, 'Period',0.05,'ExecutionMode','fixedRate','Tag','MouseTime'); %check the mouse position every 10 ms
start(timerObj);
